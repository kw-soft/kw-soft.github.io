...
- **Run It Yourself**: Want to play with the code? Visit the [GitHub repo](https://github.com/kwilck/QuicC2Py) for full setup details. Quick steps:
  1. **Clone the Repo**:
     ```bash
     git clone https://github.com/kwilck/QuicC2Py.git
     cd QuicC2Py
     ```
